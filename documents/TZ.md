...
1.2.1 (20.11.23) Обновлены изображения в разделах 3.5 и 4.5, обновлена информация в разделе 4.5 (текущая).
...
![](images/TZ/image15.png)

![](images/TZ/image16.png)
В каждой комнате находится от 2 до 4 противников на игрока, т.е. если в команде трое игроков, то стоит ожидать от 6 до 12 врагов. Каждый игрок сражается только с одним врагом одновременно, другие не могут ему помогать
...
Во время сражения случайному игроку из команды задается вопрос, пока он дает ответ для удара, остальные игроки всячески отвлекают препода на себя.
